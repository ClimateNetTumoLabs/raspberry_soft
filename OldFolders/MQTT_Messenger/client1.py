...
class MQTTThread(QThread):
    ...
    def __init__(self, mqttBrokerAddress="localhost", mqttBrokerPort=1883, client_topic="Client1"):
        super().__init__()
        ...
        self.client.subscribe("clients/Client2")
...
class InputWindow(QWidget):
    ...
    def __init__(self, mqtt_client, client_name="Client1"):
        super().__init__()
