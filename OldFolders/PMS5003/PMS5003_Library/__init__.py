...
class PMS5003:
    ...
    def __init__(self, device='/dev/ttyAMA0', baudrate=9600, pin_enable=22, pin_reset=27, pin_enable_working=False,
    ...
    def read(self):
        ...
        if len(raw_data) != frame_length:
            raise SerialTimeoutError(
                "PMS5003 Read Timeout: Invalid frame length. Got {} bytes, expected {}.".format(len(raw_data),
                                                                                                frame_length))
